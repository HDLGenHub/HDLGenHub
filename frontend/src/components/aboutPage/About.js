...
function About() {
  return (
    <div>
      ...
      <p class="md:text-4xl text-2xl font-bold text-gray-700 m-12">
      ...
      <div class="flex items-center">
        <div class="text-left md:ml-24 ml-10">
          <h2 class="font-bold md:m-10 ml-0 text-gray-700 md:text-4xl">Our Story</h2>
          <p class="mt-5 ml-10 text-gray-600 text-sm md:text-lg ">
        ...
        <img class="md:w-1/3 w-32 mr-5 mt-20" src={About2} alt="learn-photo" />
      </div>
      <div class="flex items-center">
        <img class="md:w-1/3 w-56" src={About3} alt="learn-photo" />
        <div class="text-left m-10">
          <h2 class="font-bold md:m-10 ml-0 text-gray-700 md:text-4xl">Our Commitment</h2>
          <p class="mt-5 md:m-10 text-gray-600 text-sm md:text-lg">
      ...
      <div class="bg-gray-300 h-52 rounded rounded-ss-2xl shadow-lg rounded-ee-2xl flex m-20 mt-10 md:m-20 ml-8 mr-8 pt-5 pb-5 md:justify-around">
        <div class="m-4 md:m-10">
          <h1 class="text-3xl md:text-5xl font-semibold text-orange-500 m-2">350+</h1>
          <p class="text-gray-600">registered users</p>
        </div>
        <div class="bg-amber-400 w-0.5 h-38 opacity-50"></div>
        <div class="m-4 md:m-5 md:mt-10">
          <h1 class="text-3xl md:text-5xl font-semibold text-orange-500 m-2">10+</h1>
          <p class="text-gray-600">experts from the university with best guidance</p>
        </div>
        <div class="bg-amber-400 w-0.5 h-38 opacity-50"></div>
        <div class="m-4 md:m-10">
          <h1 class="text-3xl md:text-5xl font-semibold text-orange-500 m-2">100+</h1>
