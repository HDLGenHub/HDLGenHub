    ...
    <div>
      <div class="md:mt-10 flex">
        <div class="flex flex-col justify-center font-bold md:ml-20 w-1/2 ml-10">
          <p class="lg:text-7xl md:text-4xl text-2xl md:text-left p-2">Learn today,</p>
          <p class="lg:text-7xl md:text-4xl text-2xl md:text-left p-2">Lead tomorrow</p>
        </div>
        <div class="w-1/2">
      ...
      <div class="bg-gray-100 h-52 text-center rounded rounded-ss-2xl shadow-lg rounded-ee-2xl flex m-10 md:mt-20 pt-5 pb-5 md:justify-around">
      ...
      <div class="flex items-center">
        <div class="text-left md:ml-24 ml-10 flex-col justify-center">
          <h2 class="font-bold lg:mb-16 md:mb-10 text-gray-700 md:text-4xl">Our Story</h2>
